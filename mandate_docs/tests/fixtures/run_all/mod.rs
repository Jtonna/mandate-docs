...
fn two_mandates_run_and_one_is_invalid() {
    ...
    let text_b = MANDATE
        .replacen("name: Mandate_Parser", "name: Mandate_Parser_Two", 1)
        .replacen(
            "src/domain/mandate.rs",
            "src/domain/mandate_only_in_b.rs",
            1,
        );
    ...
    assert_eq!(
        ...
        vec![
            ...
            String::new(),
            "b.yaml".to_string(),
            "  error: missing source file: src/domain/mandate_only_in_b.rs".to_string(),
